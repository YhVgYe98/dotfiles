...
(table.insert PKG (mt
    ...
    :keys [
            ...
            (mt ["<leader>db" #(call-at :dap :toggle_breakpoint)] :mode [:n] :desc "Debug: Toggle Breakpoint")
            (mt ["<leader>dB" #((call-at :dap :set_breakpoint) (vim.fn.input "Breakpoint condition: "))] :mode [:n] :desc "Debug: Set Conditional Breakpoint")
